...
def get_appr_directed_adj_keep_attr(alpha, edge_index, num_nodes, dtype, edge_weight=None):
...
def get_appr_directed_adj(alpha, edge_index, num_nodes, dtype, edge_weight=None):
    ...
    # print("\n-------edge_weight in get_appr_directed_adj()----------")
    # print(edge_weight)
    
    fill_value = 1
    # print("-------edge_index in get_appr_directed_adj() before----------")
    # print(edge_index)
    edge_index, edge_weight = add_self_loops(
        edge_index, edge_weight, fill_value, num_nodes)  
    # print("-------edge_index in get_appr_directed_adj() after----------")
    # print(edge_index)
    row, col = edge_index
    deg = scatter_add(edge_weight, row, dim=0, dim_size=num_nodes) 
    deg_inv = deg.pow(-1.0) 
