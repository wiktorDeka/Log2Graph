...
def GraphConstruction(my_example_df, graph_count_index, graph_loc_index, my_node_accum, new_node_accum, embedding_df, dataset_name):

    # =============================================================================
    # #write a function to generate a graph from each group of log events and store them as
    # 1. dataset_name_A.txt
    # 2. dataset_name_edge_attributes.txt
    # 3. dataset_name_graph_indicator.txt
    # 4. dataset_name_graph_labels.txt
    # 5. dataset_name_node_attributes.txt
    # =============================================================================
    ...
    # fp_A = root_path + "/Data/BSC/Graph/TempRaw/" + dataset_name + "_A.txt"
    fp_A = f'{root_path}/Data/{dataset_name}/Graph/TempRaw/{dataset_name}_A.txt'
    ...
    # fp_edge_weight = root_path + "/Data/BSC/Graph/TempRaw/" + dataset_name + "_edge_attributes.txt"
    fp_edge_weight = f'{root_path}/Data/{dataset_name}/Graph/TempRaw/{dataset_name}_edge_attributes.txt'
    ...
    # fp_graph_indicator = root_path + "/Data/BSC/Graph/TempRaw/" + dataset_name + "_graph_indicator.txt"
    fp_graph_indicator = f'{root_path}/Data/{dataset_name}/Graph/TempRaw/{dataset_name}_graph_indicator.txt'
    ...
    df_label = pd.read_csv(f'{root_path}/Data/{dataset_name}/anomaly_label.csv', sep=',')
    ...
    # fp_graph_labels = root_path + "/Data/BSC/Graph/TempRaw/" + dataset_name + "_graph_labels.txt"
    fp_graph_labels = f'{root_path}/Data/{dataset_name}/Graph/TempRaw/{dataset_name}_graph_labels.txt'
    ...
    # fp_node_attributes = root_path + "/Data/BSC/Graph/TempRaw/" + dataset_name + "_node_attributes.txt"
    fp_node_attributes = f'{root_path}/Data/{dataset_name}/Graph/TempRaw/{dataset_name}_node_attributes.txt'
...
def ConcatGraphs(ReadGraph, graph_count_index, my_node_accum, new_node_accum, adj_type, dataset_name):
    # =============================================================================
    ...
    # 1. Adj Matrix
    # =============================================================================
    # fp_A = root_path + "/Data/BSC/Graph/Raw/" + dataset_name + "_A.txt"
    fp_A = f'{root_path}/Data/{dataset_name}/Graph/Raw/{dataset_name}_A.txt'
    ...
    # =============================================================================
    # fp_edge_weight = root_path + "/Data/BSC/Graph/Raw/" + dataset_name + "_edge_attributes.txt"
    fp_edge_weight = f'{root_path}/Data/{dataset_name}/Graph/Raw/{dataset_name}_edge_attributes.txt'
    ...
    df_graph_indicator = pd.DataFrame(columns=["indicator"])    
    df_graph_indicator["indicator"] = [graph_count_index+1]*len(new_node_accum)
    # fp_graph_indicator = root_path + "/Data/BSC/Graph/Raw/" + dataset_name + "_graph_indicator.txt"
    fp_graph_indicator = f'{root_path}/Data/{dataset_name}/Graph/Raw/{dataset_name}_graph_indicator.txt'
    ...
    # fp_graph_labels = root_path + "/Data/BSC/Graph/Raw/" + dataset_name + "_graph_labels.txt"
    fp_graph_labels = f'{root_path}/Data/{dataset_name}/Graph/Raw/{dataset_name}_graph_labels.txt'
    ...
    # fp_node_attributes = root_path + "/Data/BSC/Graph/Raw/" + dataset_name + "_node_attributes.txt"
    fp_node_attributes = f'{root_path}/Data/{dataset_name}/Graph/Raw/{dataset_name}_node_attributes.txt'
    ...
    if adj_type == 'ib':
        ...
        # =============================================================================
        # fp_A2 = root_path + "/Data/BSC/Graph/Raw/" + dataset_name + "_A2.txt"
        fp_A2 = f'{root_path}/Data/{dataset_name}/Graph/Raw/{dataset_name}_A2.txt'
        ...
        # =============================================================================
        # fp_edge_weight2 = root_path + "/Data/BSC/Graph/Raw/" + dataset_name + "_edge_attributes2.txt"
        fp_edge_weight2 = f'{root_path}/Data/{dataset_name}/Graph/Raw/{dataset_name}_edge_attributes2.txt'
...
def generate_graphs(dataset_name):
    ...
    # =============================================================================
    # PreStep 1: Load parsed dataset 
    # =============================================================================
    df = pd.read_csv(f'{root_path}/Data/{dataset_name}/{dataset_name}.log_structured.csv', sep=',')
    ...
    # Load embedding vec from a json file
    with open(f'{root_path}/Data/Gloves/Results/{dataset_name}_embeddings.json', 'r') as fp:
    ...
    folder = f'{root_path}/Data/{dataset_name}/Graph/Raw'
    ...
    all_event_df = pd.read_csv(f'{root_path}/Data/{dataset_name}/anomaly_label.csv', sep=',')

    group_to_check = list(all_event_df["GroupId"])

    if dataset_name == "Linux":
        num_graphs_to_test = 300
        anomaly_perentage = 20/300
        draw_code_val = 1
    ...
    list_group, list_group_idx = draw_sample(num_graphs_to_test, anomaly_perentage, draw_code_val, all_event_df, group_to_check)
    ...
    for group_name in tqdm(list_group):
        ...
        MyReadGraph,empty_index = read_tu_data(folder = f'{root_path}/Data/{dataset_name}/Graph/TempRaw',
                                            prefix = dataset_name,
                                            adj_type = 'ib')
        
        if empty_index == 0: 
            ##concatenate all appr graphs (only none-empty graphs)
    ...
    graph_ids_path = f'{root_path}/Data/{dataset_name}/graph_ids.csv'
